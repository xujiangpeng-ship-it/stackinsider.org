...
Adopting new software often leads to costly mistakes. Here are the most common ones and how to sidestep them.
...
Wave’s free plan is the closest thing to a full accounting tool available without paying. The interface is clean, invoices look professional, and the mobile app lets you snap receipts on the go. The catch is that Wave’s UK support is minimal. Their help docs are US-centric. While the software technically supports UK VAT, you must manually configure it. There are no pre-built templates or HMRC-recognised formats. If you are a freelancer or micro-business with simple needs, it is workable. If you are VAT-registered, prepare for extra admin.

Zoho Books’ free tier is more UK-friendly, with built-in VAT schemes and Making Tax Digital (MTD) compliance. Automation features like recurring invoices and payment reminders are surprisingly robust for a free plan. The 1,000-invoice limit is a ticking time bomb. A small e-commerce business can hit that limit in three months. Zoho’s ecosystem is vast, including CRM and inventory. The free plan locks you out of integrations like Shopify or PayPal unless you upgrade.

## The rough edges

Wave’s lack of UK-specific support is a compliance risk. Users on forums like UK Business Forums report having to manually adjust VAT settings for each invoice, which is error-prone. One user shared that they spent an entire weekend reconfiguring their setup after Wave’s default VAT calculations did not align with HMRC’s rules for partial exemptions. Zoho Books has a steeper learning curve. The dashboard is cluttered. The free plan’s single-user restriction means you cannot even grant your accountant read-only access without upgrading.

Both tools share a glaring omission: payroll. Wave charges £20/month + £4 per employee for payroll. Zoho outsources it to a third-party provider starting at £5/month per employee. If you have even one employee, you are looking at an extra £30–£60/month. That is enough to make a paid tool like FreeAgent (£19/month all-in) a better deal.

## What the vendor won't tell you

Wave’s free plan is free because they make money on payment processing. Their transaction fees are 2.9% + 20p for card payments, higher than Stripe’s 1.4% + 20p for UK cards. They do not offer volume discounts. If you process £10,000/month in payments, you pay £310 in fees with Wave versus £160 with Stripe. Zoho Books quietly restricts API access on the free plan. If you hope to connect it to your e-commerce platform or CRM, you need to upgrade to at least the £10/month plan.

Community sentiment is mixed. On Trustpilot, Wave scores 4.2/5 as of June 2026. UK users frequently complain about slow customer support and the lack of MTD-ready reports. Zoho Books fares slightly better at 4.4/5. Users gripe about the clunky mobile app and the fact that the free plan does not include phone support.

## Who should and shouldn't use free accounting software

**Use Wave’s free plan if:**
- You are a freelancer or sole trader with fewer than 50 invoices/month.
- You do not need VAT filing, or you are happy to do it manually.
- You want a simple, no-frills tool and can live without bank feeds.

**Use Zoho Books’ free plan if:**
- You are VAT-registered but have low invoice volume.
- You need MTD compliance and can tolerate the 1,000-invoice limit.
- You are already using other Zoho tools, like CRM, and want to keep everything in one ecosystem.

**Avoid free plans if:**
- You have employees. Payroll costs will eat into your savings.
- You process more than £5,000/month in payments. Wave’s fees will sting.
- You need multi-user access or integrations. Zoho’s free plan is too restrictive.

For everyone else, a paid tool like FreeAgent or QuickBooks Simple Start (both around £10–£20/month) is a better investment. The time you save on VAT filing, bank reconciliation, and payroll will pay for itself. You will not wake up one day realising you have outgrown your "free" software.
